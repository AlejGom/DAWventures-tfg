...
<div class="flex  flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">{{ Auth::user()->name }} perfil</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6"  method="POST" action="{{ route('updateProfile') }}" enctype="multipart/form-data">
      ...
      <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Cambiar imagen de perfil</label>
      <div class="mt-2">
      ...
      <div>
        <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Cambiar usuario</label>
        <div class="mt-2">
      ...
      <div>
        <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Cambiar dirección de correo</label>
        <div class="mt-2">
      ...
      <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Guardar cambios</button>
      </div>
    </form>
  </div>
</div>
  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-sm border-t border-gray-200 pt-10">
    <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Tus experiencias</h2>
  </div>
